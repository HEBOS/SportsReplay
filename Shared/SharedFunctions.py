...
class SharedFunctions(object):
    ...
    def get_previous_frame_file_name(path, camera_number, current_time, frame_number, fps):
        ...
        return SharedFunctions.get_recording_file_name(path, camera_number, seconds, frame)
    ...
    @staticmethod
    def get_recording_file_name(path, camera_number, current_time, frame_number):
